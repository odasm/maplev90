...
function action(mode, type, selection) {
	...
	if(selection == -1 && cm.getMapId() == 926010100){
		cm.warp(926010000, 0);
		cm.dispose();
	}
	if (selection == -1) {
	...
	if (status == 1) {
		...
		if (selection == 1) {
			...
			if (mons < 50000) {
				cm.sendOk("Please defeat at least 50,000 monsters in the Pyramid and look for me again. Kills : "
								+ mons);
