						...
						if (preamble == null) {
							...
							cm.dispose();
								...
								if (cm.haveItem(4001022, 200) == false) {
									cm.sendNext("Me desculpe, mas voce nao tem todos os 200 passes necessarios para concluir esta fase.");
									cm.dispose();
								}
								else {
									cm.sendNext("Parabens pela conclusao da primeira fase, vou abrir o portal agora.");
									clear(1,eim,cm);
