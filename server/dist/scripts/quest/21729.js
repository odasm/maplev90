...
function start(mode, type, selection) {
	...
	if (status == 0) {
		...
		qm.sendPrev("#b(You think there's the password in Mysterious Statue that leads to the Puppeteer's Cave. Should you attack the puppeteer as soon as you find out the password? No, you'll find out what it is and inform Tru first.)#k", 3);
		qm.dispose();
	}
}