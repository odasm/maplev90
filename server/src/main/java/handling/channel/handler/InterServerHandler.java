...
public class InterServerHandler {
    ...
    public static final void Loggedin(final int playerid, final MapleClient c) {
        ...
        if(transfer == null){
        	NPCScriptManager.getInstance().start(player.getClient(), 9000030);
        	if(player.isAran()){
        		player.dropMessage(6, "Complete the quests marked as '[Skill]' to learn new skills! ");
        	}else{
        		player.dropMessage(6, "[Event] Talk to Mia in Henesys to help the Maple Tree to grow! It will give you awnsome items after it grows! ");
        	}
